...
#Rule ID: SV-26637r1_rule
#Severity: CAT III
#Rule Version (STIG-ID): GEN003650
#Rule Title: All local file systems must employ journaling or another mechanism that ensures file system consistency.
#
...
#
#Check Content: 
#Check that local filesystems use journaling.
# mount | grep '^/dev/' | egrep -v 'type (ext3|ext4|jfs|reiserfs|xfs|iso9660|udf)'
#If a mount is listed, this is a finding.
#
#Fix Text: Convert local file systems to use journaling or another mechanism that ensures file system consistency.    
#######################DISA INFORMATION###############################
