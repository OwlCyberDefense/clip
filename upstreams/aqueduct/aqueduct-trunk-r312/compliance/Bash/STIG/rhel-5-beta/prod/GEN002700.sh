...
# on 24-jan-2012 to check permissions before running chmod.
#
#  - updated by Shannon Mitchell(shannon.mitchell@fusiontechnology-llc.com)
# on 10-apr-2012 to check for the audit.conf file before trying to pull the 
# log_file entry from it.


#######################DISA INFORMATION###############################
#Group ID (Vulid): V-813
#Group Title: Audit logs permissions
#Rule ID: SV-27286r1_rule
#Severity: CAT II
...
#system and do not include activity, error, or other log files created 
...
#
#Fix Text: Change the mode of the audit log file(s).
