...
#Group Title: The Department of Defense (DoD) login banner
#Rule ID: SV-28596r1_rule
#Severity: CAT II
...
#
#Check Content: 
#Access the system console and make a login attempt. Check for either 
#of the following login banners based on the character limitations 
#imposed by the system. An exact match is required. If one of 
#these banners is not displayed, this is a finding.
#
...
#
#Fix Text: Edit /etc/issue and add one of the DoD login banners 
#(based on the character limitations imposed by the system).
#
#DoD Login Banners:
#
#You are accessing a U.S. Government (USG) Information System (IS) 
