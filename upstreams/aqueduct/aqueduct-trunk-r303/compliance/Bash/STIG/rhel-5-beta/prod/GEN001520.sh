...
#
#Vulnerability Discussion: If the GID of the home directory is not the 
#same as the GID of the user, this would allow unauthorized access to files.
#
...
#
#Fix Text: Change the group-owner for user home directories to the primary 
#group of the assigned user.
#
#Procedure:
