...
#
#If the group-owner is not root or the crontab owner's primary group, 
#this is a finding.
#
#Fix Text: Change the group owner of the crontab file to root, cron, 
#or the crontab's primary group.
#Procedure:
