...
#######################DISA INFORMATION###############################
#Group ID (Vulid): V-22535
#Group Title: GEN000000-LNX007580
#Rule ID: SV-26905r1_rule
#Severity: CAT II
#Rule Version (STIG-ID): GEN000000-LNX007580
#Rule Title: The PF_LLC protocol handler must not be bound to the 
#network stack.
#
