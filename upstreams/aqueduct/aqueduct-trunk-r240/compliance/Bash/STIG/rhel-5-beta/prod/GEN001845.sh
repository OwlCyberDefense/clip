...
#Rule ID: SV-26478r1_rule
#Severity: CAT II
#Rule Version (STIG-ID): GEN001845
#Rule Title: Global initialization files' library search paths must contain 
#only absolute paths.
#
...
#system libraries. This variable is formatted as a colon-separated list of 
#directories. If there is an empty entry, such as a leading or trailing 
...
# grep LD_LIBRARY_PATH /etc/profile /etc/bashrc /etc/csh.login 
