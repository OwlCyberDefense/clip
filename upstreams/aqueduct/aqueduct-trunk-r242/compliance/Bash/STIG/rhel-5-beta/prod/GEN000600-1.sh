...
#######################DISA INFORMATION###############################
#Group ID (Vulid): V-11948-1
#Group Title: Password Character Mix
#Rule ID: SV-27118-1r1_rule
#Severity: CAT II
#Rule Version (STIG-ID): GEN000600-1
...
#Addressing this check in GEN000460
