...
#directories. RHEL5 does not include inetd service in its distribution. 
#It has been replaced by xinetd.
#
#Procedure:
...
#this is a finding.
#
#Fix Text: Change the group-owner of the xinetd configuration files 
#and directories.
#
#Procedure:
