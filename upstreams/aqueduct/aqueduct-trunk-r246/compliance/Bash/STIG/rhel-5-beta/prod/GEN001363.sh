...
#the system's DNS resolver. DNS is used to resolve host names to IP addresses. 
#If DNS configuration is modified maliciously, host name resolution may 
#fail or return incorrect information. DNS may be used by a variety of 
#system security functions such as time synchronization, centralized 
...
#is a finding.
#
#Fix Text: Change the group-owner of the /etc/resolv.conf file to 
