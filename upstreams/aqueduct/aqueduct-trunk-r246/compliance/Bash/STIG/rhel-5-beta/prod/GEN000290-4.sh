...
#######################DISA INFORMATION###############################
#Group ID (Vulid): V-4269-4
#Group Title: Unnecessary Accounts, Ftp.
#Rule ID: SV-4269-4r4_rule
#Severity: CAT II
...
#
#Check Content: 
#Check the system the unnecessary "ftp" accounts.
#
#Procedure:
# grep ^ftp /etc/passwd
#If this account exists, it is a finding.
#
#Fix Text: Remove the "ftp" account from the /etc/password file 
#before connecting a system to the network.   
#######################DISA INFORMATION###############################

#Global Variables#
PDI=GEN000290-4
FTPACCOUNT=`grep -c '^ftp' /etc/passwd`
