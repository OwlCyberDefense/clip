...
#colon-separated list of directories. If there is an empty entry, such 
#as a leading or trailing colon, or two consecutive colons, this is 
...
# grep PATH /etc/profile /etc/bashrc /etc/csh.login /etc/csh.cshrc 
...
#
#
#Fix Text: Edit the global initialization file(s) with PATH variables 
#containing relative paths. Edit the file and remove the relative path 
