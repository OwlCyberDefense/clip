...
#Group Title: Root Shell
#Rule ID: SV-1062r7_rule
#Severity: CAT III
#Rule Version (STIG-ID): GEN001080
#Rule Title: The root shell must be located in the / file system.
#
#Vulnerability Discussion: To ensure that the root shell is available in repair and administrative modes, the root shell must be located in the / file system.
#
...
#
#Fix Text: Change the root account's shell to one present on the / file system.
#
#Procedure:
