...
#Group Title: System Files and Directories Group Ownership
#Rule ID: SV-796r7_rule
#Severity: CAT II
#Rule Version (STIG-ID): GEN001240
#Rule Title: System files, programs, and directories must be group-owned 
#by a system group.
#
#Vulnerability Discussion: Restricting permissions will protect the files 
...
#
#If any system file, program, or directory is not owned by a system 
#group, this is a finding.
#
#Fix Text: Change the group-owner of system files to a system group.
#
#Procedure:
