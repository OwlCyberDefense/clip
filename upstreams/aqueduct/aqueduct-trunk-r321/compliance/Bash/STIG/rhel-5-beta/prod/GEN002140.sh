...
#/etc/shells file, except any shells specified for the purpose of preventing logins.
#
#Vulnerability Discussion: The shells file lists approved default shells. 
#It helps provide layered defense to the security approach by ensuring 
#users cannot change their default shell to an unauthorized shell that may 
#not be secure.
#
...
#considered valid shells for use in the /etc/passwd file, but will not 
#be listed in the /etc/shells file.
#
...
#Fix Text: Use the "chsh" utility or edit the /etc/passwd file and correct 
#the error by changing the default shell of the account in error to an 
