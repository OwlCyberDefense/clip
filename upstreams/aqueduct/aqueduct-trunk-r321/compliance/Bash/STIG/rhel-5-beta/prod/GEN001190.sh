...
# on 05-jan-2012 to include an ACL check before running setfacl.
								     

#######################DISA INFORMATION###############################
#Group ID (Vulid): V-22313
#Group Title: GEN001190
#Rule ID: SV-26359r1_rule
#Severity: CAT II
#Rule Version (STIG-ID): GEN001190
#Rule Title: All network services daemon files must not have extended ACLs.
#
#Vulnerability Discussion: Restricting permission on daemons will protect 
#them from unauthorized modification and possible system compromise.
#
