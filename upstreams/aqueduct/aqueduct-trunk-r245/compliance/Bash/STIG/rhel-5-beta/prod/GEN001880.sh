...
#
#If local initialization files are more permissive than 
#0740 or the .dt directory is more permissive than 0755 
#or the .dtprofile file is more 
#permissive than 0755, this is a finding.
#
#Fix Text: Ensure user startup files have permissions of 
#0740 or more restrictive. Examine each user’s home directory 
#and verify that all file names that begin with "." have 
#access permissions of 0740 or more restrictive. If they 
#do not, use the chmod command to correct the vulnerability.
#
#Procedure:
