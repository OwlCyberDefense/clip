...
#Group Title: The cron.allow permissions
...
#such as who is allowed to execute cron programs, which could be 
#harmful to overall system and network security.
#
...
#
#Fix Text: Change the mode of the cron.allow file to 0600.
#
#Procedure:
