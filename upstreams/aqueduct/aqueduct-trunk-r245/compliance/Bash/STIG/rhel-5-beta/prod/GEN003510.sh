...
#contents of system memory at the time of the crash. Kernel core 
#dumps may consume a considerable amount of disk space and may result 
#in denial of service by exhausting the available space on the 
#target file system. The kernel core dump process may increase the 
#amount of time a system is unavailable due to a crash. Kernel core 
