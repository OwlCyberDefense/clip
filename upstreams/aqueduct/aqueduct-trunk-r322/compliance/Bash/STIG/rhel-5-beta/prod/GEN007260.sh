...
#
#Vulnerability Discussion: The AppleTalk suite of protocols is
#no longer in common use. Binding this protocol to the network
#stack increases the attack surface of the host. Unprivileged
#local processes may be able to cause the system to dynamically
...
#
#Check Content: 
#The AppleTalk protocol handler is not part of the RHEL5 distribution. This is not a finding.
#######################DISA INFORMATION###############################
