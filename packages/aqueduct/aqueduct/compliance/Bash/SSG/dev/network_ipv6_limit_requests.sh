...
set_sysctl_param net.ipv6.conf.default.autoconf 0
set_sysctl_param net.ipv6.conf.default.dad_transmits 0
set_sysctl_param net.ipv6.conf.default.max_addresses 1
