...
#Rule ID: SV-26355r1_rule
#Severity: CAT II
#Rule Version (STIG-ID): GEN000945
#Rule Title: The root account's library search path must be the system default and must contain only absolute paths.
#
...
#
#Check Content: 
#Check that the LD_LIBRARY_PATH environment variable is empty or not defined for the root user.
# echo $LD_LIBRARY_PATH
#If a path list is returned, this is a finding.
#
#Fix Text: Edit the root user initialization files and remove any definition of LD_LIBRARY_PATH.   
#######################DISA INFORMATION###############################
