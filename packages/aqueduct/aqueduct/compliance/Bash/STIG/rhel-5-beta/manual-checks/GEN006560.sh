...
#Group Title: Security Tool Notifications
#Rule ID: SV-12529r3_rule
#Severity: CAT II
#Rule Version (STIG-ID): GEN006560
#Rule Title: The system vulnerability assessment tool, host-based intrusion detection tool, and file integrity tool must notify the SA and the IAO of a security breach or a suspected security breach.
#
#Vulnerability Discussion: Timely notifications of potential security compromises minimize the potential damage.
#
...
#
#Fix Text: Configure the security tools on the system to notify the IAO and SA when any security issues are detected.   
#######################DISA INFORMATION###############################
