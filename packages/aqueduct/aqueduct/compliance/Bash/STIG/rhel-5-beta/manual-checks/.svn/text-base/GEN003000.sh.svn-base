...
#Group Title: Cron Executes World Writable Programs
#Rule ID: SV-27330r1_rule
#Severity: CAT II
#Rule Version (STIG-ID): GEN003000
#Rule Title: Cron must not execute group-writable or world-writable programs.
#
#Vulnerability Discussion: If cron executes group-writable or world-writable programs, there is a possibility that unauthorized users could manipulate the programs with malicious intent. This could compromise system and network security.
#
#
...
#
#Fix Text: Remove the world-writable and group-writable permissions from the cron program file(s) identified.
