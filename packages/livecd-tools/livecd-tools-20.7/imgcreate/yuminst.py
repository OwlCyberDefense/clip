...
class LiveCDYum(yum.YumBase):
    ...
    def selectGroup(self, grp, include = pykickstart.constants.GROUP_DEFAULT):
        ...
        if include == pykickstart.CONSTANTS.GROUP_REQUIRED:
            package_types.remove('default')
        elif include == pykickstart.CONSTANTS.GROUP_ALL:
