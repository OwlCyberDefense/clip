...
%define rpmmacrodir %{_usr}/lib/rpm/macros.d/
%define devel_dir %{_usr}/share/selinux/clip
...
BuildRequires: policycoreutils-python m4 policycoreutils policycoreutils-devel python36 make gcc checkpolicy >= %{CHECKPOL_VERSION}
...
%attr(755,root,root) %{devel_dir}/policyhelp
...
cat << EOF > %{buildroot}/%{rpmmacrodir}/macros.clip
